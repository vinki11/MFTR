...
namespace ProjetMFTR.Forms
{
	public partial class Communication : Form
	{
		...
		private void cboReferent_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			interlocutors.Add(new Interlocutor() { FirstName = referent.Adultes.Nom, Name = referent.Adultes.Prenom, Adulte_ID = referent.Adultes.Adulte_ID, FullName = AdultWrapper.GetFullName(referent.Adultes) });
