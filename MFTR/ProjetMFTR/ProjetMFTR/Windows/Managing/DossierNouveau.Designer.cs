namespace ProjetMFTR.Forms
{
	partial class DossierNouveau
	{
		...
		private void InitializeComponent()
		{
			...
			this.tbCarriers = new System.Windows.Forms.TabPage();
			...
			this.tc.Controls.Add(this.tbDocuments);
			this.tc.Controls.Add(this.tbCarriers);
			this.tc.Controls.Add(this.tbPayments);
			...
			this.tbDocuments.Size = new System.Drawing.Size(1285, 496);
			this.tbDocuments.TabIndex = 2;
			this.tbDocuments.Text = "Documents";
			this.tbDocuments.UseVisualStyleBackColor = true;
			// 
			// tbCarriers
			// 
			this.tbCarriers.Location = new System.Drawing.Point(4, 22);
			this.tbCarriers.Name = "tbCarriers";
			this.tbCarriers.Size = new System.Drawing.Size(1285, 496);
			this.tbCarriers.TabIndex = 3;
			this.tbCarriers.Text = "Transporteurs";
			this.tbCarriers.UseVisualStyleBackColor = true;
			// 
			// tbPayments
			// 
			this.tbPayments.Controls.Add(this.PaymentsGrid);
			this.tbPayments.Location = new System.Drawing.Point(4, 22);
			this.tbPayments.Name = "tbPayments";
			this.tbPayments.Size = new System.Drawing.Size(1285, 496);
			this.tbPayments.TabIndex = 4;
			this.tbPayments.Text = "Paiements";
			...
			this.PaymentsGrid.AutoSizeRowsMode = System.Windows.Forms.DataGridViewAutoSizeRowsMode.AllHeaders;
            ...
            this.Intervenant});
			this.PaymentsGrid.DataSource = this.bsPayments;
			...
			// 
			this.datePaymentDataGridViewTextBoxColumn.DataPropertyName = "DatePayment";
			this.datePaymentDataGridViewTextBoxColumn.HeaderText = "Date du paiement";
			this.datePaymentDataGridViewTextBoxColumn.Name = "datePaymentDataGridViewTextBoxColumn";
			this.datePaymentDataGridViewTextBoxColumn.ReadOnly = true;
			// 
			// carrierDataGridViewTextBoxColumn
			// 
			this.carrierDataGridViewTextBoxColumn.DataPropertyName = "Carrier";
			this.carrierDataGridViewTextBoxColumn.HeaderText = "Transporteur";
			...
			this.Intervenant.DataPropertyName = "Intervenant";
			...
			// bsPayments
			// 
			this.bsPayments.DataSource = typeof(ProjetMFTR.Entities.Helper.PaymentViewModel);
			// 
			// DossierNouveau
			// 
		...
		private System.Windows.Forms.TabPage tbCarriers;
