...
namespace ProjetMFTR.Forms
{
	public partial class Dossier : Form
	{
		...
		public Dossier(List<Entities.Dossier> folders)
		{
			InitializeComponent();
			Init(folders);
		}
		...
		public void Init()
		{
			Init(Connexion.Instance().Dossier.OrderByDescending((x) => x.Ouverture).ToList());
		}

		public void Init(List<Entities.Dossier> folders)
		{
